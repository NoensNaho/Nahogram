...
from kivy.storage.jsonstore import JsonStore  # OTOMATİK GİRİŞ İÇİN EKLENDİ
...
class NahogramApp(MDApp):
    ...
    def on_start(self):
        ...
        # EĞER ÖNCEDEN GİRİŞ YAPILMIŞSA DİREKT İÇERİ AL
            ...
            try:
                ...
                if res.status_code == 200 and res.json():
                    ...
                    if kullanici_verisi["sifre"] == sifre:
                        # GİRİŞ BAŞARILI, HAFIZAYA KAYDET
    ...
    def cikis_yap(self):
        # TELEFONUN HAFIZASINDAN HESABI SİL
        if self.store.exists("oturum"):
    ...
    def akis_yenile(self):
        if self.is_fetching_akis: return  # ÇİFT YÜKLEMEYİ (KASMAYI) ENGELLER
        ...
        def islem():
            try:
                ...
                if gonderiler_res.status_code == 200 and gonderiler_res.json():
                    ...
                    cizilecekler = []
                    post_keys = list(gonderiler.keys())[-20:]  # OPTİMİZASYON: SADECE SON 20 GÖNDERİ (KASMA YAPMAZ)
                    ...
                    def arayuzu_ciz(dt):
                        ...
                        feed_box.clear_widgets()  # EKRANI TERTEMİZ SİL
